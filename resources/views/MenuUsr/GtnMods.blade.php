...
<h1 class="text-center">Gestión de moderadores</h1> <br />
...
<table class="table table-striped table-success">
 ...
 @if (!$items->is_Admin==1 AND $items->role == 'mod')
 	<tr>
      <td>{{ $items->name }}</td>
      <td>{{ $items->role }}</td>
...
<br /><h3>Acciones para ejecutar</h3><br />
  ...
  <div>
    <a href="{{ route('GtnMods.create')}}" class="btn btn-primary">Agregar Moderador</a>
  </div>
